...
exports.handler = async (event) => {
  ...
  const { renderId, bucketName } = await renderMediaOnLambda({
    ...
    inputProps: {
      ...
      slides:       event.slides,
      chartSlides:  event.chartSlides,
      hookStat:     event.hookStat,
      selfieVideoUrl: event.selfieVideoUrl,
      dollarBuysText: event.dollarBuysText,
      notableSalesVariant: event.notableSalesVariant,
      notableSalesItems: event.notableSalesItems,
      localMomentText: event.localMomentText,
      ctaVariant: event.ctaVariant,
      ctaText: event.ctaText,
      shortsChartIndex: event.shortsChartIndex,
    },
    codec:           "h264",
    imageFormat:     "jpeg",
    maxRetries:      1,
